...
function build(previousSizeMap) {
  ...
  webpack(config).watch({}, (err, stats) => {
    ...
    if (homepagePath && homepagePath.indexOf('.github.io/') !== -1) {
      ...
      console.log('  ' + chalk.cyan('git') + ' add -f ' + buildDir);
      console.log('  ' + chalk.cyan('git') + ' commit -am ' + chalk.yellow('"Rebuild website"'));
      console.log('  ' + chalk.cyan('git') + ' filter-branch -f --prune-empty --subdirectory-filter ' + buildDir);
      ...
      console.log('  ' + chalk.cyan('pushstate-server') + ' ' + buildDir);
